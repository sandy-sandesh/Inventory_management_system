...
urlpatterns = [
    ...
    # Password reset (uses templates under Dashboard/templates/Dashboard/)
    path('password-reset/', auth_views.PasswordResetView.as_view(template_name='Dashboard/password_reset_form.html'), name='password_reset'),
